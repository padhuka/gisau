...
<a href="{{ route('country.edit',$model) }}" class="btn btn-warning btn-sm">Edit</a>
<button href="{{ route('country.destroy',$model) }}" class="btn btn-danger btn-sm" id="delete">Hapus</button>
