                                                ...
                                                <div class="card-block">
                                                   ...
                                                   <form action="{{ route('country.update',$country) }}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" value="{{ $country->code_country }}" name="code" @error('code') is-invalid @enderror id="">
                                                                @error('code')
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" value="{{ $country->name_country }}" name="name" @error('name') is-invalid @enderror id="">
                                                                @error('name')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
                                                            </div>
