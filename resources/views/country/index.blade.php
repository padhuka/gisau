                                        ...
                                        <div class="row">
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5><a href="{{ route('country.create') }}" class="btn btn-info btn-sm float-end mb-2">Tambah Negara</a></h5>
                                                ...
                                                <div class="card-block">
                                                    <div class="dt-responsive table-responsive">
                                                        ...
                                                        <table id="dataCountries" class="table table-striped table-bordered nowrap">
                                                            <thead>
                                                            <tr>
                                                                <th>No.</th>
                                                                <th>Kode Negara</th>
