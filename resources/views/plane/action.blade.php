...
<a href="{{ route('plane.edit',$model) }}" class="btn btn-warning btn-sm">Edit</a>
<button href="{{ route('plane.destroy',$model) }}" class="btn btn-danger btn-sm" id="delete">Hapus</button>
