...
<head>
    <title>Sistem Informasi Pangkalan Militer</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('adminty\libraries\assets\pages\prism\prism.css')}}">
    <!-- Style.css -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('adminty\libraries\assets\css\pcoded-horizontal.min.css')}}">
    @stack('styles')
</head>
...
<![endif]-->
    ...
    <script type="text/javascript" src="{{ asset('adminty\libraries\bower_components\modernizr\js\css-scrollbars.js')}}"></script>

    <!-- Syntax highlighter prism js -->
    <script type="text/javascript" src="{{ asset('adminty\libraries\assets\pages\prism\custom-prism.js')}}"></script>
    <!-- i18next.min.js -->
    <script type="text/javascript" src="{{ asset('adminty\libraries\bower_components\i18next\js\i18next.min.js')}}"></script>
    <script type="text/javascript" src="{{ asset('adminty\libraries\bower_components\i18next-xhr-backend\js\i18nextXHRBackend.min.js')}}"></script>
    <script type="text/javascript" src="{{ asset('adminty\libraries\bower_components\i18next-browser-languagedetector\js\i18nextBrowserLanguageDetector.min.js')}}"></script>
    <script type="text/javascript" src="{{ asset('adminty\libraries\bower_components\jquery-i18next\js\jquery-i18next.min.js')}}"></script>
    <!-- Custom js -->
    <script src="{{ asset('adminty\libraries\assets\js\pcoded.min.js')}}"></script>
    <script src="{{ asset('adminty\libraries\assets\js\menu\menu-hori-fixed.js')}}"></script>
    <script src="{{ asset('adminty\libraries\assets\js\jquery.mCustomScrollbar.concat.min.js')}}"></script>
    <script type="text/javascript" src="{{ asset('adminty\libraries\assets\js\script.js')}}"></script>
