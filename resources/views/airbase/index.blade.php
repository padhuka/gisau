                                        ...
                                        <div class="row">
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5><a href="{{ route('airbase.create') }}" class="btn btn-info btn-sm float-end mb-2">Tambah Pangkalan Udara</a></h5>
                                                ...
                                                <div class="card-block">
                                                    <div class="dt-responsive table-responsive">
                                                        ...
                                                        <table id="dataAirbases" class="table table-striped table-bordered nowrap">
                                                            <thead>
                                                            <tr>
                                                                <th>No.</th>
                                                                <th>Kode Pangkalan Udara</th>
                                                                <th>Nama Pangkalan Udara</th>
                                                                <th>Negara</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
