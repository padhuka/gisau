                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-block">
                            ...
                            <form action="{{ route('airbase.update',$airbase) }}" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="country">
                                            ...
                                            <option value="{{$country->id}}" {{ $country->id == $airbase->country_id ?
                                                'selected' : '' }}>{{$country->name_country}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="{{ $airbase->code_airbase }}"
                                            name="code" @error('code') is-invalid @enderror id="">
                                        @error('code')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="{{ $airbase->name_airbase }}"
                                            name="name" @error('name') is-invalid @enderror id="">
                                        @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="previewImage" class="mb-2" src="{{ $airbase->getImage() }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="description" class="form-control @error('description')
                                            ...
                                            placeholder="Deskripsi">{{ $airbase->description }}</textarea>
                                        @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
