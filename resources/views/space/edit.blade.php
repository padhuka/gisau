                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <form action="{{ route('space.update',$space) }}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" name="name" value="{{ $space->name }}" @error('name') is-invalid @enderror" id="">
                                                                @error('name')
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <img id="previewImage" class="mb-2" src="{{ $space->getImage() }}" width="200px" height="200px" alt="">
