                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-block">
                            ...
                            <form action="{{ route('space.update',$space) }}" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="name" value="{{ $space->name }}"
                                            @error('name') is-invalid @enderror" id="">
                                        @error('name')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="previewImage" class="mb-2" src="{{ $space->getImage() }}" width="200px"
                                            height="200px" alt="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="location" value="{{ $space->location }}
                                            ...
                                            is-invalid @enderror readonly id="">
                                        @error('location')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
