                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">Spaces</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5><a href="{{ route('space.create') }}" class="btn btn-info btn-sm float-end mb-2">Tambah Data</a></h5>
                                                ...
                                                <div class="card-block">
                                                    <div class="dt-responsive table-responsive">
                                                        ...
                                                        <table id="dataSpaces" class="table table-striped table-bordered nowrap">
                                                            <thead>
                                                            <tr>
                                                                <th>No.</th>
                                                                <th>Nama Space</th>
