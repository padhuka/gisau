                                        ...
                                        <div class="row">
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5><a href="{{ route('centre-point.create') }}" class="btn btn-info btn-sm float-end mb-2">Tambah Data</a></h5>
                                                ...
                                                <div class="card-block">
                                                    <div class="dt-responsive table-responsive">
                                                        ...
                                                        <table id="dataCentrePoint" class="table table-striped table-bordered nowrap">
                                                            <thead>
                                                            <tr>
                                                                <th>No.</th>
