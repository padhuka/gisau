                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <!--<h4>Peta</h4>-->
                                                        <h4>Data Pesawat di Pangkalan Udara</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    <div class="dt-responsive table-responsive">
                                                        ...
                                                        <table id="dataPlaneairbases" class="table table-striped table-bordered nowrap">
                                                            <thead>
                                                            <tr>
                                                                <th>No.</th>
                                                                <th>Skuadron</th>
