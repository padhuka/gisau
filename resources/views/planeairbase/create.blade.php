                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <!--<h4>Peta</h4>-->
                                                        <h4>Tambah Pesawat di Pangkalan Udara</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">Pesawat di Pangkalan Udara</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="card">
                                                <div class="card-block">
                                                    <h4 class="sub-title">Pesawat di Pangkalan Udara</h4>
                                                    <form action="{{ route('planeairbase.store') }}" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select class="form-control" name="airbase">
                                                                    ...
                                                                    @foreach ($airbases as $airbase)
                                                                        <option value="{{$airbase->id}}">{{$airbase->name_airbase}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select class="form-control" name="plane">
                                                                    ...
                                                                    @foreach ($planes as $plane)
                                                                        <option value="{{$plane->id}}">{{$plane->name_plane}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
